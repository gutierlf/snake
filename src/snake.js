...
if (typeof _user$project$Snake$main !== 'undefined') {
    _user$project$Snake$main(Elm['Snake'], 'Snake', {"types":{"unions":{"Snake.Msg":{"args":[],"tags":{"Tick":["Time.Time"],"TogglePause":[]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"Snake.Msg"},"versions":{"elm":"0.18.0"}});
}
